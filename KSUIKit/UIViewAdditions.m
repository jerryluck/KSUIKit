...
const CGFloat cxkDefaultTransitionDuration      = 0.3;
...
- (void)presentAsKeyboardInView:(UIView*)containingView {
  ...
  [UIView setAnimationDuration:cxkDefaultTransitionDuration];
...
+ (CAGradientLayer*)gradientLayerWithFrame:(CGRect)frame startPoint:(CGPoint)startPoint endPoint:(CGPoint)endPoint colors:(NSArray*)colors locations:(NSArray*)locations
{
